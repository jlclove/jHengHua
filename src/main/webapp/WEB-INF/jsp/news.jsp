    ...
    <div class="row">
        <div class="col-sm-8">
            <div class="news-box">
                ...
                <div class="news-info animated">
                    <a href="#">
                        <p>“驻店裁缝，SUITSUPPLY正以全新的零售体验征服全世界”</p>
                        <div class="text-right">“SUITSUPPLY，整合直营的一站式西服专家，让你看上去完美无瑕！”</div>
                    </a>
                </div>
            </div>
            <div class="news-list row mt30 news-left">
                <div class="col-sm-6">
                    <a href="#">
                        ...
                        <p>2015春夏系列广告，欧洲品牌Suitsupply携荷兰知名摄影大师Carli Hermes长途跋涉来到南半球被誉为南非之母的神奇土地——开普敦城，在好望角的悬崖边进行了一场唯美的水下拍摄。</p>
                ...
                <div class="col-sm-6">
                    <a href="#">
                        ...
                        <p class="title">SUITSUPPLY 新加坡店铺开业</p>
        ...
        <div class="col-sm-4 news-right">
            ...
            <ul class="list-unstyled news-list">
                <li>
                    <a href="">“驻店裁缝，SUITSUPPLY正以全新的零售体验征服全世界” </a> 六月 25, 2015
                </li>
                <li>
                    <a href="#">SUITSUPPLY荣获2015欧洲电子商务峰会多渠道拓展（OMNICHANNEL）组金奖</a> 六月 15, 2015
                </li>
                <li>
                    <a href="#">SUITSUPPLY进驻BLOOMINGDALE'S百货</a> 五月 10, 2015
                </li>
                <li>
                    <a href="#">2015 春夏广告大片</a> 二月 19, 2015
                </li>
                <li>
                    <a href="#">SUITSUPPLY 新加坡店铺开业</a> 十月 14, 2014
                </li>
            </ul>
            ...
            <ul class="list-unstyled news-list">
                ...
                <li>
                    <a href="#">独家预览：SUITSUPPLY 2015春夏系列 </a>七月 11, 2014
                </li>
                <li>
                    <a href="#">SUITSUPPLY 2014 秋冬系列广告片——“独”有的气质！ </a>九月 3, 2014
                </li>
            </ul>
        </div>
    </div>
