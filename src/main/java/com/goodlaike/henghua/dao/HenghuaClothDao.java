...
public class HenghuaClothDao extends LocalRWDao<HenghuaCloth> {
	...
	public int deleteBySerialNo(String serialNo) {
		return super.getSqlSession().delete("HenghuaCloth.delete", serialNo);
	}
	 ...
	 */
	public List<HenghuaCloth> search(long id, String material, String wearStyle, String mainColor, String style,
