...
public class RestHenghuaController extends BaseRestController {
  ...
  protected ResponseEntity<?> getSampleList(HttpServletRequest request, @RequestParam(value = "sinceId", defaultValue = "0") long id) {
  ...
  protected ResponseEntity<?> searchSample(HttpServletRequest request, @RequestParam(value = "sinceId", defaultValue = "0") long id,
      @RequestParam(value = "level", required = false) String level, @RequestParam(value = "style", required = false) String style,
      @RequestParam(value = "gramWeight", required = false) String gramWeight, @RequestParam(value = "season", required = false) String season,
  ...
  protected ResponseEntity<?> getClothList(HttpServletRequest request, @RequestParam(value = "sinceId", defaultValue = "0") long id) {
