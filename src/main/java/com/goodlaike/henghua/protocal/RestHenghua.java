...
public class RestHenghua {
   ...
   */
  public HenghuaSampleDetail2 restSampleDatail(String detailId) {
    String restStr = this.restSampleDetailStr(detailId);
    return this.getObject(restStr, HenghuaSampleDetail2.class);
  }
   ...
   * @since 2016年6月5日 下午2:09:06
   */
  public List<HenghuaSampleDetail2> restSampleDatailAll() {
    String restStr = this.restSampleDetailAllStr();
    return this.getList(restStr, HenghuaSampleDetail2.class);
  }
